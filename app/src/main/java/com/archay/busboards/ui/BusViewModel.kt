...
class BusViewModel @Inject constructor(private var useCase: BusUseCase) : BaseViewModel() {
    ...
    fun previousStations(): List<StationDto> {
        ...
        list.add(StationDto("Kurantlar\nbekati"))
        list.add(StationDto("6-tugruxona"))
        list.add(StationDto("1-Tibbiyot \nakademiyasi"))
        list.add(StationDto("Mirzo Ulugbek \nkochasi"))
        list.add(StationDto("Botkin kochasi"))
        list.add(StationDto("S. Mashhadiy \nkochasi"))
        list.add(StationDto("Politologiya \ninstituti"))
        list.add(StationDto("Buyak ipak \nyoli metrosi"))
        list.add(StationDto("Sayohat \nmehmonhonasi"))
        list.add(StationDto("Salom kafesi"))
        list.add(StationDto("Mirishkor kochasi"))
        list.add(StationDto("Dormon yoli \nkochasi"))
        list.add(StationDto("Gulshan bogi"))
        list.add(StationDto("Nevrologiya \nsanatoriyasi"))
        return list
    }
